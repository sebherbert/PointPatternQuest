...
save([path,name,'Case',num2str(k),'_Analysis07NN'],'dn');

savefig([path,name,'Case',num2str(k),'_Analysis07Fig1']);

saveas(gcf,[path,name,'Case',num2str(k),'_Analysis07Fig1'], 'tiffn');
clear dn
clear G
