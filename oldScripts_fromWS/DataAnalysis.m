...
for k=1
    ...
    if exist([path,filename(1:end-4),'_xyzCASE',num2str(k),'.mat'])
        ...
        ColorRange(1)=7;%Fig 3&4: min distance in µm (red)
        ColorRange(2)=12;%Fig 3&4: max distance in µm (blue
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %Main Function
        ...
        ColorRange(1,1)=5;%Fig 1: min distance in µm (red)
        ColorRange(1,2)=9;%Fig 1: max distance in µm (blue)
        
        %Fig2: local density I+II      
        ColorRange(2,1)=5;%Fig 2: min distance in µm (red)
        ColorRange(2,2)=9;%Fig 2: max distance in µm (blue)
                      
        %Fig3: local density II
        ColorRange(3,1)=10;%Fig 3: min distance in µm (red)
        ColorRange(3,2)=50;%Fig 3: max distance in µm (blue)
        
        %Fig4: local density III
        ColorRange(4,1)=7;%Fig 4: min distance in µm (red)
        ColorRange(4,2)=20;%Fig 4: max distance in µm (blue)
