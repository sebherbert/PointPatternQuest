function Analysis04PointPatternAnalysisSecondNeighbor(path,filename,k,x,y,z,S,d12_all,d12_1)
...
%         dn(i)=dtemp(2);
    ...
    xlabel('distance to 2nd nearest neighbor (in cell diameter)');
...
%         text(0.5,0.85,[num2str(d1min),'µm min dist.' ])
        ...
        saveas(gcf,[path,filename(1:end-4),'Case',num2str(k),'_Analysis04Fig1'], 'tiffn');
    clear dn
    clear G
