function Analysis05PointPatternAnalysisFirstNeighbor(path,filename,k,x,y,z,S,d123_all,d123_1)
...
%         text(0.5,0.85,[num2str(d1min),'µm min dist.' ])
        ...
        saveas(gcf,[path,filename(1:end-4),'Case',num2str(k),'_Analysis05Fig1'], 'tiffn');
    clear dn
    clear G
